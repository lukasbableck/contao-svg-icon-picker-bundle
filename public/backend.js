...
var _default = /*#__PURE__*/function (_Controller) {
  function _default() {
    ...
    _defineProperty(_this, "selectedIcon", _this.element.querySelector('.selected-icon'));
    _defineProperty(_this, "inputField", _this.element.querySelector('input[type="hidden"]'));
    _defineProperty(_this, "picker", _this.element.querySelector('.picker-container'));
    return _this;
  }
  ...
  return _createClass(_default, [{
    ...
    value: function filterIcons(event) {
      ...
      icons.forEach(function (icon) {
        ...
        var searchterms = JSON.parse(icon.getAttribute('data-search-terms')) || [];
    ...
    key: "setActiveIcon",
    value: function setActiveIcon(value) {
    ...
    key: "setSelectedIcon",
    value: function setSelectedIcon(icon) {
